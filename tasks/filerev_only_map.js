...
module.exports = function (grunt) {
  grunt.registerMultiTask('filerev_only_map', 'File revisioning based on content hashing', function () {
    var target = this.target;
    var filerev = grunt.filerev_only_map || {summary: {}};
    ...
    grunt.filerev_only_map = filerev;
  });
};
